...
export default async function StudioIALandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black">
      ...
      <section className="relative py-7 sm:py-14">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mb-2 max-w-3xl text-base font-semibold leading-snug text-gray-100 sm:text-xl">Crie sua música com IA, direto pelo celular.</p>
            <p className="mx-auto mb-5 max-w-3xl text-sm leading-relaxed text-gray-400">Escreva a ideia, escolha o estilo e gere letra, áudio, capa e página pública em poucos passos.</p>
            <StudioHeroActions />
          </div>
              ...
              <div className="relative overflow-hidden rounded-2xl border border-purple-500/20 bg-black/80 p-5 text-left">
                ...
                <div className="relative">
                  <div className="mb-4 flex items-center justify-between gap-3">
                    ...
                    <span className="rounded-full border border-purple-500/40 bg-purple-600/20 px-3 py-1 text-xs font-bold text-purple-100">IA + Studio</span>
                  </div>
                  ...
                  <div className="mb-4 rounded-2xl border border-gray-800 bg-gray-950/80 p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between text-xs text-gray-500"><span>Letra, voz e instrumental</span><span>2 versões</span></div>
                  </div>
      ...
      <section className="py-6 sm:py-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-5 text-center sm:mb-7"><h2 className="text-2xl font-black sm:text-3xl">Como funciona</h2></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl rounded-[1.5rem] border border-purple-700/50 bg-gradient-to-br from-purple-950/50 via-gray-950 to-black p-5 sm:p-7">
            <div className="flex flex-col gap-4 md:flex-row md:items-start">
              ...
              <div>
                <p className="mb-2 text-sm font-bold uppercase tracking-wide text-purple-300">Primeiro registro da sua criação</p>
                <h2 className="text-xl font-black sm:text-2xl">Sua música nasce com histórico dentro da DCC Music</h2>
                <p className="mt-3 text-sm leading-relaxed text-gray-300">Ao criar sua letra e sua música no DCC Studio IA, o projeto fica registrado com data, autoria da conta e histórico de criação dentro da plataforma.</p>
                <p className="mt-3 text-xs text-gray-500">Esse histórico serve como apoio de anterioridade e organização da criação. Ele não substitui registros oficiais de direitos autorais quando forem necessários.</p>
              </div>
            </div>
          </div>
        </div>
