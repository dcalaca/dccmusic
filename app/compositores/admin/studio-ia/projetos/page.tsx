                          ...
                          <div className="mb-3 flex items-start justify-between gap-3">
                            <div>
                              ...
                              <h3 className="mt-1 line-clamp-2 font-black text-white">
                                {getAutoGeneratedStudioVersionNumber(version.versionName) !== null
                                  ? t('studio.project.versions.generatedSongNumber', { number: versionNumber })
                    ...
                    {playbackAssets.map((asset) => (
                      <article key={asset.id} className="rounded-3xl border border-gray-800 bg-gray-950/70 p-4 sm:p-5">
                        <div className="mb-4">
                          ...
                          <p className="mt-1 text-xs text-gray-500">{getAutoGeneratedStudioVersionNumber(asset.versionName) !== null
                            ? t('studio.project.versions.generatedSongNumber', { number: getAutoGeneratedStudioVersionNumber(asset.versionName) })
                            : asset.versionName || t('studio.projects.labels.songVersion')} · {t('studio.projects.labels.separatedOn', { date: formatDate(asset.createdAt, i18n.language) })}</p>
                        </div>
