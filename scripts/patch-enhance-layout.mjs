...
const genreText = "t('studio.tools.ready.genre')"
...
if (customVoiceMarkerIndex !== -1) {
  ...
  const nextStyleHeading = source.indexOf("              <p className=\"mb-3 mt-5 text-sm font-bold text-gray-300\">{t('studio.tools.ready.voiceStyle')}</p>", customVoiceMarkerIndex)
...
if (customVoiceBlock) {
  const voiceSection = `            <div className="mt-5">\n              <div className="mb-2 flex items-center justify-between gap-3">\n                <div>\n                  <p className="text-sm font-black text-white">{t('studio.tools.ready.registeredVoice')}</p>\n                  <p className="mt-1 text-xs text-gray-400">{t('studio.tools.ready.registeredVoiceHint')}</p>\n                </div>\n              </div>\n${customVoiceBlock}            </div>\n\n`
...
const lyricAnchor = "            <div className=\"mt-5\">\n              <div className=\"mb-2 flex flex-wrap items-center justify-between gap-2\">\n                <span className=\"text-sm font-bold text-gray-300\">{t('studio.tools.ready.lyrics')}"
