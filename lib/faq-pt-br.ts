export const faqsPtBr = [
  ...
  },
  {
    category: 'Studio IA',
    questions: [
      { question: 'O que é o Studio IA?', answer: 'O Studio IA é a ferramenta do DCC Music para criar músicas com inteligência artificial. Você informa o nome, estilo, clima e ideia da música, e o sistema ajuda a criar letra, arranjo, áudio e capa.' },
      { question: 'A IA cria a letra também?', answer: 'Sim. Você pode pedir para a IA gerar uma letra do zero, melhorar uma letra existente ou completar uma ideia que você já começou.' },
      { question: 'Posso enviar uma música pronta para melhorar?', answer: 'Sim. Na opção de melhorar música, você pode enviar um áudio pronto para a IA usar como referência e gerar uma nova produção.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'Como reporto erro ou problema no site?', answer: 'Entre em contato pelo email suporte@dccmusic.online. Se possível, envie seu email de cadastro, o código do projeto e uma descrição simples do que aconteceu.' },
    ],
  },
]
