...
export default function Footer() {
  ...
  const showBlog = i18n.language.startsWith('pt')
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                <li><Link href="/videos" className="text-gray-400 hover:text-white transition-colors">{t('footer.links.videos')}</Link></li>
                ...
                {!showEmail ? (
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      title={copied ? t('common.actions.copied') : t('footer.copyEmail')}
                      aria-label={copied ? t('common.actions.copied') : t('footer.copyEmail')}
                    >
